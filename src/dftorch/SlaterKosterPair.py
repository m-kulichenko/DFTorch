...
def Slater_Koster_Pair_SKF_vectorized(
    ...
    HSPS_all = (
        coeffs_selected[:, 0]
        + coeffs_selected[:, 1] * dx[tmp_mask]
        + coeffs_selected[:, 2] * dx[tmp_mask] ** 2
        + coeffs_selected[:, 3] * dx[tmp_mask] ** 3
    )
    ...
    HSPS_dR = (
        coeffs_selected[:, 1]
        + 2 * coeffs_selected[:, 2] * dx[tmp_mask]
        + 3 * coeffs_selected[:, 3] * dx[tmp_mask] ** 2
    )
