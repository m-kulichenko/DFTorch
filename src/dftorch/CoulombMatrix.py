...
def CoulombMatrix_vectorized(Hubbard_U, TYPE, RX, RY, RZ, LBox, lattice_vecs, Nr_atoms,
...
def Ewald_Real_Space_vectorized(Hubbard_U, TYPE, dR, dR_dxyz, nnType, neighbor_I, neighbor_J,
                  CALPHA):
    """
    ...
    dCC_dxyz_real.index_add_(1, neighbor_I*(Nats) + neighbor_J, dtmp1*dR_dxyz[nn_mask].T  )
