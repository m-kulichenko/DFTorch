...
def init_processes(backend):
    ...
    mu0, fullGraph = scf(structure, dftorch_params, fullGraph,
        partsCoreHalo[start:end], numCores[start:end], nbr_state, disps, dists, nl, works_per_rank, NJUMPS, GTHRESH, MAX_DEG, device)
